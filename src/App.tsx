...
import { AlertTriangle, Dribbble, Target, Gift, X, Heart, Rocket, Activity, Loader2, Sun, Moon } from 'lucide-react';
...
export default function App() {
  // Navigation State
  const [view, setView] = useState<'GAME' | 'RESPONSIBLE' | 'FOOTBALL_SIM'>('GAME');
  ...
  return (
    <div className={`min-h-screen ${isLightMode ? 'bg-gray-100 text-black' : 'bg-slate-950 text-white'} font-sans flex flex-col md:flex-row overflow-hidden relative transition-colors duration-500`}>
        ...
        <div className="flex-1 flex flex-col h-screen overflow-y-auto">
            ...
            <main className="flex-1 p-4 md:p-6 flex flex-col gap-4 overflow-y-auto relative">
                <GameCanvas 
                    phase={phase} 
